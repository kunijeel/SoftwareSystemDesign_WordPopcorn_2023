...
public class ObstacleTwo extends Obstacle {
    ...
    // ObstacleTwo 생성자
    public ObstacleTwo(int panelWidth, int panelHeight, int size) {
        super(0, 0, size, 0, 0, "/Image/avoidancegame/obstacletwo.png"); // 다른 이미지를 사용할 수 있습니다.
        this.image = new ImageIcon(Objects.requireNonNull(getClass().getResource("/Image/avoidancegame/obstacletwo.png"))).getImage();
